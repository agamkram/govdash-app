...
**Live:** GitHub → Vercel → [markmaga.com](https://markmaga.com) (GovernmentDashboard). Layouts: Icicle, Tree, Circles, Sankey. How-to and glossary live in the in-app About page (`A`).
